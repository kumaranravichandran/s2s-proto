...
.dtp > .dtp-content > .dtp-date-view > header.dtp-header { background: #6a9031; color: #fff; text-align: center; padding: 0.3em; }

.dtp div.dtp-date, .dtp div.dtp-time { background: #6a9031; text-align: center; color: #fff; padding: 10px; }
...
.dtp table.dtp-picker-days tr > td > a.selected{ background: #6a9031; color: #fff; }
...
.dtp .dtp-actual-meridien a.selected { background: #6a9031; color: #fff; }
